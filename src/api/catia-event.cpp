...
CatiaEvent CatiaEvent::fromJSON(const json_t *json, json_error_t */* error */)
{
    CatiaEvent event;
...
CatiaEvent CatiaEvent::fromJSONV2(const json_t *json, json_error_t */* error */)
{
    CatiaEvent event;
...
std::vector<CatiaEvent> CatiaEvent::listFromJSON(const json_t *json, json_error_t *error, bool is_use_new_json_parser)
{
    std::vector<CatiaEvent> events;
